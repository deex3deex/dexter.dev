...
- `.languages`: the language focus breakdown inside the hero terminal: HTML 30%, CSS 25%, JavaScript 25%, and Java 20%.
...
The language bars inside the hero terminal show the current focus split. Their percentages are written in the HTML and should total 100% when updated.
