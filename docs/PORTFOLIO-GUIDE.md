...
- `.languages`: the language focus breakdown below the About section: HTML 30%, CSS 25%, JavaScript 25%, and Java 20%.
...
The language bars below the About section show the current focus split. Their percentages are written in the HTML and should total 100% when updated.
